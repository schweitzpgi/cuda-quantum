...
// CHECK:           %[[VAL_3:.*]] = quake.get_number_of_qubits %[[VAL_0]] :
// (!cc.ptr<!quake.state>) -> i64 CHECK:           %[[VAL_5:.*]] = quake.alloca
// !quake.veq<?>[%[[VAL_3]] : i64] CHECK:           %[[VAL_6:.*]] =
// quake.init_state %[[VAL_5]], %[[VAL_0]] : (!quake.veq<?>,
