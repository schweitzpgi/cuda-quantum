...
// CHECK:           %[[VAL_8:.*]] = quake.concat %[[VAL_2]], %[[VAL_3]] :
// (!quake.ref, !quake.ref) -> !quake.veq<2> CHECK:           quake.apply
// @__nvqpp__mlirgen__heisenbergU [%[[VAL_8]]] %{{.*}} : (!quake.veq<2>,
// !quake.veq<?>) -> () CHECK:           return
...
// CHECK:           %[[VAL_7:.*]] = quake.concat %{{.*}}, %{{.*}} : (!quake.ref,
// !quake.ref) -> !quake.veq<2> CHECK:           quake.apply
// @__nvqpp__mlirgen__givens [%[[VAL_7]]] %{{.*}}, %{{.*}}, %{{.*}} :
// (!quake.veq<2>, f64, !quake.ref, !quake.ref) -> () CHECK:           return
...
// CHECK:           quake.apply
// @__nvqpp__mlirgen__function_magic_func._Z[[mangle]] [%{{.*}}] %{{.*}} :
// (!quake.ref, !quake.veq<?>) -> () CHECK:           return
...
// CHECK-SAME:       %{{[^:]*}}: f64{{.*}}, %[[VAL_1:.*]]: !quake.ref{{.*}},
// %[[VAL_2:.*]]: !quake.ref{{.*}}, %[[VAL_3:.*]]: !quake.ref{{.*}},
// %[[VAL_4:.*]]: !quake.ref{{.*}}) CHECK:           %[[VAL_7:.*]] =
// quake.concat %[[VAL_1]], %[[VAL_4]] : (!quake.ref, !quake.ref) ->
// !quake.veq<2> CHECK:           quake.x %[[VAL_4]] CHECK: quake.apply
// @__nvqpp__mlirgen__givens [%[[VAL_7]]] %{{.*}}, %[[VAL_2]], %[[VAL_3]] :
// (!quake.veq<2>, f64, !quake.ref, !quake.ref) -> () CHECK:           quake.x
// %[[VAL_4]] : (!quake.ref) -> () CHECK:           quake.x [%[[VAL_2]]]
// %[[VAL_1]] : (!quake.ref, !quake.ref) -> () CHECK:           quake.x
// [%[[VAL_3]]] %[[VAL_4]] : (!quake.ref, !quake.ref) -> () CHECK: return
